...
The project's niche application required us to utilize an unconventional evaluation method: using a strong **Large Language Model (LLM) as a judge** to evaluate our model, outlined in [this paper](https://arxiv.org/abs/2306.05685). Namely, we evaluated our fine-tuned model using [Mixtral&#8209;8x7B&#8209;v0.1](https://huggingface.co/mistralai/Mixtral-8x7B-v0.1) through a _Single Answer Grading_ and _Reference-Guided Grading_ approach, where our model achieved an average score of 90% and 80% respectively.
...
This project was done by **Ali Jaafar** and **Nadim Akkaoui** as their Final Year Project.
